...
$featurearray = array("Citizenship Status" => array("US-born citizen","Immigrant"),"Race/Ethnicity" => array("White","Latino","Black","Asian"),"Religion" => array("Christian","Muslim","(No information available)"),"Work Attitude" => array("Very motivated to get back to work and actively looking for a job","Not motivated to get back to work and not looking for a job","(No information available)"),"Health" => array("Victim of a work-related injury","Fit and healthy"),"Work history" => array("Always had a regular job","Never had a regular job"),"Volunteer experience" => array("Regularly does volunteer work","Does not have time for volunteer work"));
